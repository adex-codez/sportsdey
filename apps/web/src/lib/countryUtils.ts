...
export const getCountryFromCompetition = (competitionName: string): { country: string; flag: string } => {
  ...
  const cityCountryMap: Record<string, { country: string; flag: string }> = {
    ...
    // UK
    'london': { country: 'United Kingdom', flag: 'https://flagcdn.com/w40/gb.png' },
    'wimbledon': { country: 'United Kingdom', flag: 'https://flagcdn.com/w40/gb.png' },
    'birmingham': { country: 'United Kingdom', flag: 'https://flagcdn.com/w40/gb.png' },
    ...
    'sharm elsheikh': { country: 'Egypt', flag: 'https://flagcdn.com/w40/eg.png' },
    
    // Angola
    'luanda': { country: 'Angola', flag: 'https://flagcdn.com/w40/ao.png' },
    
    // Netherlands
    'amsterdam': { country: 'Netherlands', flag: 'https://flagcdn.com/w40/nl.png' },
    'rotterdam': { country: 'Netherlands', flag: 'https://flagcdn.com/w40/nl.png' },
    ...
    // Czech Republic
    'prague': { country: 'Czech Republic', flag: 'https://flagcdn.com/w40/cz.png' },
    'olomouc': { country: 'Czech Republic', flag: 'https://flagcdn.com/w40/cz.png' },
    'brno': { country: 'Czech Republic', flag: 'https://flagcdn.com/w40/cz.png' },
    
    // Russia
    'moscow': { country: 'Russia', flag: 'https://flagcdn.com/w40/ru.png' },
    'st petersburg': { country: 'Russia', flag: 'https://flagcdn.com/w40/ru.png' },
    ...
    // Argentina
    'buenos aires': { country: 'Argentina', flag: 'https://flagcdn.com/w40/ar.png' },
    ...
    // Mexico
    'mexico city': { country: 'Mexico', flag: 'https://flagcdn.com/w40/mx.png' },
  ...
  const countryMap: Record<string, { country: string; flag: string }> = {
    ...
    'united kingdom': { country: 'United Kingdom', flag: 'https://flagcdn.com/w40/gb.png' },
    ...
    'netherlands': { country: 'Netherlands', flag: 'https://flagcdn.com/w40/nl.png' },
    ...
    'switzerland': { country: 'Switzerland', flag: 'https://flagcdn.com/w40/ch.png' },
    'austria': { country: 'Austria', flag: 'https://flagcdn.com/w40/at.png' },
    'czech republic': { country: 'Czech Republic', flag: 'https://flagcdn.com/w40/cz.png' },
    ...
    'south korea': { country: 'South Korea', flag: 'https://flagcdn.com/w40/kr.png' },
