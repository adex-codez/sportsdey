                ...
                <table className="w-full text-sm min-w-[300px]">
                    <thead>
                        <tr className="border-b border-[#C8C8C8]">
                            <th className="text-left py-4 px-4 font-semibold text-primary w-1/2">Players</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">1</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">2</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">3</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">4</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">5</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">PTS</th>
                            <th className="text-center py-4 px-2 font-semibold text-primary">S</th>
                        </tr>
                    </thead>
                    <tbody>
                        {players.map((player, idx) => (
                            <tr key={idx} className={cn("border-b border-[#E5E5E5] last:border-b-0", idx % 2 === 0 ? "bg-white" : "bg-white")}>
                                ...
                                {player.periodScores.map((score, sIdx) => (
                                    <td key={sIdx} className="text-center py-4 px-2 text-primary font-medium">
                                        {score}
                                    </td>
                                ))}
                                ...
                                <td className="text-center py-4 px-2 font-medium text-primary">{player.pts}</td>
                                <td className="text-center py-4 px-2 font-medium text-primary">{player.s}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
