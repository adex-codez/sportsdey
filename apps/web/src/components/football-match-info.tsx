		...
		<div className="space-y-4">
			<div className="rounded-2xl bg-white">
				<div className="flex justify-between items-center px-4 py-2 font-semibold">
					<div className="w-full"><span className="text-primary font-semibold text-sm truncate">Standings</span></div>
					<div className="flex gap-x-4">
<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">P</span>
<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">W</span>
<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">D</span>
<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">L</span>
<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">GD</span>
<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">PTS</span>
					</div>
				...
				{info.standings?.map((standing) => (
					...
					>
						...
						<div className="flex gap-x-4">
							<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">{standing.played}</span>
							<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">{standing.won}</span>
							<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">{standing.drawn}</span>
							<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">{standing.lost}</span>
							<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">{standing.goal_diff}</span>
							<span className="text-primary font-semibold text-xs w-4 md:w-10 lg:w-14 text-center">{standing.points}</span>
						</div>
					</div>
				))}
			</div>
